...
int main(int argc, char **argv) {
    ...
    printf("        INTERACTIVE MENU with command arguments       \n");
    printf("        the first argument is always the hunt you want to work on!\n");
    printf("    1. For adding a treasure, type 'add'!\n");
    printf("    2. For listing info about a hunt, type 'list'!\n");
    printf("    3. For viewing a specific treasure, type 'view' followed by the respective ID!\n");
    printf("    4. For removing a specific treasure, type 'remove_treasure' followed by the respective ID!\n");
    printf("    5. For removing an entire hunt, type 'remove_hunt'!\n");
    printf("-------------------------------------------------------------------------------------------------------\n");
    ...
    if (strcmp(argv[2], "add") == 0) {
        ...
        view_treasure(argv[1], atoi(argv[3]));
    } else if (strcmp(argv[2], "remove_treasure") == 0) {
        if(argc != 4){
            perror("error with the command arguments");
            exit(1);
        }
        remove_treasure(argv[1], atoi(argv[3]));
